...
import useStyles from '@styles/globals.styles.js'
...
const PlaceDetails = ({ place, selected, refProp }) => {
  ...
  return (
    <Card elevation={6}>
      <CardMedia
        style={{ height: 350 }}
        image={place.photo ? place.photo.images.large.url : 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcR_qYlo4n-xjIB_AfQZjwmDL6F7lnN8O5G3mA&usqp=CAU'}
        title={place.name}
      />
      <CardContent>
